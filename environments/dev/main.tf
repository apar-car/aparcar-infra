module "vpc" {
  source = "git::https://github.com/apar-car/aparcar-infra.git//modules/vpc?ref=71076d0c15d6d993c2887b860802fba33bb0c65d"
...
module "leave_signal_handler" {
  source = "git::https://github.com/apar-car/aparcar-infra.git//modules/lambda?ref=71076d0c15d6d993c2887b860802fba33bb0c65d"
...
module "parking_signals_table" {
  source = "git::https://github.com/apar-car/aparcar-infra.git//modules/dynamodb?ref=71076d0c15d6d993c2887b860802fba33bb0c65d"
...
module "waf" {
  source = "git::https://github.com/apar-car/aparcar-infra.git//modules/waf?ref=71076d0c15d6d993c2887b860802fba33bb0c65d"
